...
<head>
    ...
    <title>Crear Evento - Event Hunters</title>
        ...
        <form action="../CONTROLLER/eventsController.php" method="post" id="contForm">
            ...
            <div id="contTitle">
                ...
                <div id="contInputs">
                    ...
                    <!-- Nombre del evento -->
                    <input type="text" name="nameEvent" placeholder="Nombre del evento" pattern="^[A-Za-z ]{5,50}$"
                        required>

                    <!-- Lugar del evento -->
                    <input type="text" name="placeEvent" placeholder="Lugar del evento"
                        pattern="^[A-Za-z0-9]{5,50}$" required>

                    <!-- Fecha del evento -->
                    <input type="date" name="dateEvent" placeholder="Fecha del evento"
            ...
            <div id="contSession">
                <button class="btnNext" name="btnNext">
                    <a class="contVolver" href="../VIEW/cuentaAdmin.php">
                        <svg class="arrowVolver" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
